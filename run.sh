...
python /content/drive/MyDrive/stable-diffusion-webui-colab/stable-diffusion-webui/launch.py --listen --xformers --enable-insecure-extension-access --update-all-extensions --update-check --theme dark --gradio-queue --multiple
